...
export const sportsOptions = [
    ...
    { name: 'Flexibility', icon: FlexibilityIcon, description: 'Yoga, Stretching, Pilates' },
    { name: 'Martial Arts', icon: MartialArtsIcon, description: 'Boxing, Kung Fu' },
    { name: 'Race Training', icon: RaceTrainingIcon, description: 'Iron Man, Marathons' },
    { name: 'Game Sports', icon: GameSportsIcon, description: 'Football, Tennis' },
    { name: 'None of the above', icon: '', description: '' },
  ];
